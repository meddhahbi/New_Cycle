...
const CreateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const loc = await axios.get("https://ipapi.co/json").then(async loc=>{
      console.log(loc.data)

      console.log(userInfo)
      let city = loc ? loc.data.city : "tunis"
      let country = loc ? loc.data.country_name : "tunisia"
      let region = loc ? loc.data.region : "el ghazala"
      let latitude = loc ? loc.data.latitude : 36.8232
      let longitude = loc ? loc.data.longitude : 10.1701
