                                                ...
                                                <div className="product-box-3 theme-bg-white h-100">
                                                    ...
                                                    <div className="product-footer">
                                                        <div className="product-detail">
                                                            ...
                                                            <a href="product-left-thumbnail.html">
                                                                <h5 className="name">Fresh Bread and Pastry Flour 200
                                                                    g</h5>
                                                            </a>
                                                ...
                                                <div className="product-box-3 theme-bg-white h-100">
                                                    ...
                                                    <div className="product-footer">
                                                        <div className="product-detail">
                                                            <span className="span-name">Vegetable</span>
                                                            <a href="product-left-thumbnail.html">
                                                                <h5 className="name">Peanut Butter Bite Premium Butter
                                                                    Cookies
                                                                    600 g</h5>
                                                            </a>
                                                ...
                                                <div className="product-box-3 theme-bg-white h-100">
                                                    ...
                                                    <div className="product-footer">
                                                        <div className="product-detail">
                                                            ...
                                                            <a href="product-left-thumbnail.html">
                                                                <h5 className="name">SnackAmor Combo Pack of Jowar Stick
                                                                    and
                                                                    Jowar Chips</h5>
                                                            </a>
                                            ...
                                            <div className="order-box dashboard-bg-box">
                                                ...
                                                <div className="product-order-detail">
                                                    ...
                                                    <div className="order-wrap">
                                                        ...
                                                        <p className="text-content">Cheddar dolcelatte gouda. Macaroni
                                                            cheese
                                            ...
                                            <div className="order-box dashboard-bg-box">
                                                <div className="order-container">
                                                    ...
                                                    <div className="order-detail">
                                                        ...
                                                        <h6 className="text-content">Cheese on toast cheesy grin cheesy
                                                            grin
                                                ...
                                                <div className="product-order-detail">
                                                    ...
                                                    <div className="order-wrap">
                                                        ...
                                                        <p className="text-content">Pecorino paneer port-salut when the
                                                            cheese
                                            ...
                                            <div className="order-box dashboard-bg-box">
                                                ...
                                                <div className="product-order-detail">
                                                    ...
                                                    <div className="order-wrap">
                                                        ...
                                                        <p className="text-content">The big cheese cream cheese pepper
                                                            jack
                                    ...
                                    <div className="dashboard-privacy">
                                        ...
                                        <div className="dashboard-bg-box mt-4">
                                            ...
                                            <div className="privacy-box">
                                                ...
                                                <p className="text-content">Once your account is deleted, you will be
                                                    logged out
                                            ...
                                            <button className="btn theme-bg-color btn-md fw-bold mt-4 text-white">Delete
                                                My
                                                Account
                                            </button>
                                        </div>
